...
@section('title') In - Material | Admin - Beko  @endsection
...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') In - Material @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                     <button type="button" style="float: right; margin: 2px;" class="btn btn-success customer_btn btn" id="add-btn" onclick="modalShow()"><i class="bx bx-plus"></i> เพิ่ม </button>
                 
                    <h4 class="card-title">In - Material</h4>
                    <br>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('in-mat.upload') }}" method="POST" id="import-file" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
            ...
            simple = $('#simple_table').DataTable({
                ...
                "columns": [
...

                    {
                        "data": "qty",
                        "render" : function (data, type, full){
                            let text = `<span class="text-success"> ${data} </span>`;
                            return text
                        }
                    },
                     {
        ...
        function desrtoy(id) {
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.post("{{ route('in-mat.destroy') }}", data = {
                            _token: '{{ csrf_token() }}',
                            id: id,
                        },
                        function(res) {
